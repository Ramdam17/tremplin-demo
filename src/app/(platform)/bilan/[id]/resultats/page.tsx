...
export default function ResultatsPage() {
    ...
    const handleSelectJob = (jobId: string) => {
        // Navigate to Plan page with selected job
        // Ideally saving to state, here just navigating
        ...
        <div className="space-y-8">
            <div className="text-center max-w-2xl mx-auto mb-10">
                ...
                <p className="text-muted-foreground text-lg">
                    Basé sur votre profil (Opérateur de production, 12 ans exp.) et vos compétences, voici les métiers les plus accessibles et porteurs.
                </p>
            </div>
