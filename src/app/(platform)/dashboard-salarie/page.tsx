        ...
        <PageContainer>
            <div className="flex flex-col gap-8">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <Link href="/badges/maintenance-niv1">
                        <Card className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 border-emerald-100 dark:border-emerald-900 shadow-sm hover:shadow-md transition-shadow cursor-pointer group h-full">
                            <CardHeader>
                    ...
                    <Link href="/financement/droits">
                        <Card className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20 border-blue-100 dark:border-blue-900 shadow-sm hover:shadow-md transition-shadow cursor-pointer group h-full">
                            <CardHeader>
